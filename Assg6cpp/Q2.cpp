    ...
    cin>>choice;
            ...
            case 1:
                if(index<3)
                {
                  ...
                  arr[index]->acceptProduct();         //as accept is declared as virtual in base class product these call will call the accept of derived class bookk as object is of book type
                  index++;
                }
                else
                {
            ...
            case 2:
                ...
                {
                  arr[index]=new Tape();
                  arr[index]->acceptProduct();  ////as accept is declared as virtual in base class product these call will call the accept of derived class "Tape" as object is of "Tape" type
                  index++;
                }
                else
                {
